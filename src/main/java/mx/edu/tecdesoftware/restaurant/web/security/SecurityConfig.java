...
public class SecurityConfig {
    ...
    public SecurityConfig(JwtFilter jwtFilter) {
        ...
        System.out.println(">>> SECURITY CONFIG CARGADO CORRECTAMENTE <<<");
    }
    ...
    @Bean
    public UserDetailsService userDetailsService(ClienteCrudRepository clienteRepository) {
        return email -> clienteRepository.findByCorreoElectronico(email)
